...
u8 SettingsPanel::radioButtonCount[SettingsPanel::maxPageCount] ={ 3, 5, 3, 3 }; //menu, race, Physics, host
u8 SettingsPanel::scrollerCount[SettingsPanel::maxPageCount] ={ 1, 1, 0, 1 }; //menu, race, Physics, host
