...
enum PhysicsSettings {
    SETTINGPHYSICS_RADIO_FAST_FALL,
    SETTINGPHYSICS_RADIO_ALWAYS_DRIFT,
    SETTINGPHYSICS_RADIO_BRAKE_DRIFT,
};
...
enum PhysicsSettingFASTFALL {
    PHYSICSSETTING_FAST_FALL_DISABLED = 0x0,
    PHYSICSSETTING_FAST_FALL_ENABLED = 0x1,
};

enum PhysicsSettingALWAYSDRIFT {
    PHYSICSSETTING_ALWAYS_DRIFT_DISABLED = 0x0,
    PHYSICSSETTING_ALWAYS_DRIFT_ENABLED = 0x1,
};

enum PhysicsSettingBRAKEDRIFT {
    PHYSICSSETTING_BRAKE_DRIFT_DISABLED = 0x0,
    PHYSICSSETTING_BRAKE_DRIFT_ENABLED = 0x1,
};
